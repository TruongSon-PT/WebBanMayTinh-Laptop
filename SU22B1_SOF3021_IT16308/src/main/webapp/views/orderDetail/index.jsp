		...
		<div>
			...
			<div class="py-2">
				<c:if test="${ order.status == 0 }">
					<a class="btn btn-primary text-light fw-semibold fs-5"
						href="/su22b1_it16308_sof3021/orderDetail/update1/${ order.id }">Duyệt đơn</a>
					<a class="mx-2 btn btn-danger text-light fw-semibold fs-5"
						href="/su22b1_it16308_sof3021/orderDetail/update2/${ order.id }">Hủy đơn</a>
				</c:if>
			</div>
		</div>
		<div>
